...
const info = [
    {
        icon: < FaPhoneAlt />,
        title: "Phone",
        description: "(+92) 370 30830 97",
    },
    {
        icon: < FaEnvelope />,
        title: "Email",
        description: "kl1420807@gmail.com",
    },
    {
        icon: < FaMapMarkerAlt />,
        title: "Addrees",
        description: "Street 9 Block C , New Saeedabad Baldia Town Karachi",
    },
];
            ...
            <div className="flex flex-col xl:flex-row gap-[30px] ">
                ...
                <div className="xl:w-[54%] order-2 xl:order-none">
                    <form className="flex flex-col gap-6 p-8 bg-[#27272c] rounded-xl">
                        ...
                        <p className="text-white/60">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Aperiam inventore tempore quis similique error!</p>
                        {/* input */}
